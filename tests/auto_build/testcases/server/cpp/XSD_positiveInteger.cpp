...
RequiredAttributeElement* XSD_positiveInteger::asRequiredAttribute(RequiredAttributeElement* Value0)  
{
	return Value0;
}
OptionalAttributeElement* XSD_positiveInteger::asOptionalAttribute(OptionalAttributeElement* Value0)  
{
	return Value0;
}
