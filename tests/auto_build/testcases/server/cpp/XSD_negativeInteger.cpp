...
RequiredAttributeElement* XSD_negativeInteger::asRequiredAttribute(RequiredAttributeElement* Value0)  
{
	return Value0;
}
OptionalAttributeElement* XSD_negativeInteger::asOptionalAttribute(OptionalAttributeElement* Value0)  
{
	return Value0;
}
