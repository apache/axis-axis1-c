...
RequiredAttributeElement* XSD_unsignedInt::asRequiredAttribute(RequiredAttributeElement* Value0)  
{
	return Value0;
}
OptionalAttributeElement* XSD_unsignedInt::asOptionalAttribute(OptionalAttributeElement* Value0)  
{
	return Value0;
}
