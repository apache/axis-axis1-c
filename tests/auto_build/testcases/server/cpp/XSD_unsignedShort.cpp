...
RequiredAttributeElement* XSD_unsignedShort::asRequiredAttribute(RequiredAttributeElement* Value0)  
{
	return Value0;
}
OptionalAttributeElement* XSD_unsignedShort::asOptionalAttribute(OptionalAttributeElement* Value0)  
{
	return Value0;
}
