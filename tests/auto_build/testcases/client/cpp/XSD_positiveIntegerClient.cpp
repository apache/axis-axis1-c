...
*/
        ...
        arrayInput.m_Array = new xsd__positiveInteger*[2];
        xsd__positiveInteger * array = new xsd__positiveInteger[2];
        arrayInput.m_Size = 2;
        ...
        {
            cout << "  element[" << index << "]=" << *((xsd__positiveInteger*)(arrayResult.m_Array[index])) << endl;
