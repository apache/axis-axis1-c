...
{
    char endpoint[256];
    const char* url="http://localhost:80/axis/XSD_NMTOKENPort";
    ...
    try
    {
        ...
        XSD_NMTOKENPort* ws = new XSD_NMTOKENPort(endpoint);
      
        char emptyNMTOKEN[1] = "";
        xsd__NMTOKEN emptyInput = new char[1];
        strcpy (emptyInput, emptyNMTOKEN);
        ...
        char reservedCharactersNMTOKEN[] = "<>&\"\'";
        xsd__NMTOKEN reservedCharactersInput = reservedCharactersNMTOKEN;
        ...
        // Test non-nillable element with XML reserved characters
        char whitespaceNMTOKEN[] = "  \t\r\nsome text \t\r\nmore text \t\r\n";
        xsd__NMTOKEN whitespaceInput = whitespaceNMTOKEN;
        ...
        input = new char[25];
        strcpy (input, simpleNMTOKEN);
        xsd__NMTOKEN nillableResult = ws->asNillableElement(input);
        if (nillableResult)
        {
            if (*nillableResult)
            {
        ...
        arrayInput.m_Array = new xsd__NMTOKEN[2];
        arrayInput.m_Size = 2;
