...
*/
        ...
        arrayInput.m_Array = new xsd__nonPositiveInteger*[2];
        xsd__nonPositiveInteger * array = new xsd__nonPositiveInteger[2];
        arrayInput.m_Size = 2;
        ...
        {
            cout << "  element[" << index << "]=" << *((xsd__nonPositiveInteger*)(arrayResult.m_Array[index])) << endl;
