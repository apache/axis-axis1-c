...
/* This program will create 10 Threads and each thread will invoke SimpleTypeArray Service 
   @Author James
*/
...
RETTYPE ThreadFunc(ARGTYPE Param)
{
        ...
        char *p=(char *)Param;
        char endpoint[256];
        const char* url="http://localhost:9080/SimpleTypeArray/services/sampleWS";
        if(p!=NULL)
             url=p;
