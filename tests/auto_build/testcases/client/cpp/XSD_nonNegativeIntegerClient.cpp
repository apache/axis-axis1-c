...
*/
        ...
        arrayInput.m_Array = new xsd__nonNegativeInteger*[2];
        xsd__nonNegativeInteger * array = new xsd__nonNegativeInteger[2];
        arrayInput.m_Size = 2;
        ...
        {
            cout << "  element[" << index << "]=" << *((xsd__nonNegativeInteger*)(arrayResult.m_Array[index])) << endl;
