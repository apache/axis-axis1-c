...
/* This program will create 10 Threads and each thread will invoke SimpleTypeInnerUnboundedInOutput Service 
   @Author James
*/
...
RETTYPE ThreadFunc(ARGTYPE Param)
{
        ...
        char *p=(char *)Param;
        char endpoint[256];
        const char* url="http://localhost:9080/SimpleTypeInnerUnboundedInOutput/services/sampleWS";
        if(p!=NULL)
             url=p;
