...
public class CParsingTool {
    ...
    /**
     * Read in any include files before the main processing of the tool
     * is done. This constructs the Headers.
     */
    ...
    /**
     * Checks the target directory and creates it if it doesn't already 
     * exist.
     */
	protected File maybeCreateDirectory(String option) throws Exception {
		...
		if (!file.exists() && !file.mkdir())
			Utils.rude("Failed to create directory " + file);
		return file;
	}
