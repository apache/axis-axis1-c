        ...
        else
        {
            ...
            catch (NoSuchMethodError noSuchMethodError)
            {
                ...
                if (noSuchMethodError
                    .getMessage()
                    .indexOf("org.apache.axis.wsdl.symbolTable.CElementDecl.getMinOccrs")
                    > -1)
                {
                    System.out.println(
                        "We have caught the following error - "
                            + noSuchMethodError);
                    System.out.println("");
                    System.out.println(
                        "This usually occurs when axis java jar file comes before WSDL2ws.jar in your classpath.");
                    System.out.println(
                        "Please verify that WSDL2ws.jar comes first in your classpath and correct if necessary");
                    System.out.println(
                        "If it does and you still get this error then please raise an issue with the supplier of your code");
                }
