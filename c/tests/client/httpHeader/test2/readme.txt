This client application can be used to test the set/get/remove multiple http headers.
In the first part of the program it sets some http headders.Then it calls echostring method and then it gets the http headers and remove them.
