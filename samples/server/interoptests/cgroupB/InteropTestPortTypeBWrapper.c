...
int echoSimpleTypesAsStructWrapped(IWrapperSoapDeSerializer DZ, IWrapperSoapSerializer SZ)
{
	...
	return SZ._functions->addOutputCmplxParam(SZ._object, ret, (void*)Axis_Serialize_SOAPStruct, (void*)Axis_Delete_SOAPStruct, "echoSimpleTypesAsStructReturn", Axis_URI_SOAPStruct);
}
...
int echoNestedStructWrapped(IWrapperSoapDeSerializer DZ, IWrapperSoapSerializer SZ)
{
	...
	return SZ._functions->addOutputCmplxParam(SZ._object, ret, (void*)Axis_Serialize_SOAPStructStruct, (void*)Axis_Delete_SOAPStructStruct, "echoNestedStructReturn", Axis_URI_SOAPStructStruct);
}
...
int echoNestedArrayWrapped(IWrapperSoapDeSerializer DZ, IWrapperSoapSerializer SZ)
{
	...
	return SZ._functions->addOutputCmplxParam(SZ._object, ret, (void*)Axis_Serialize_SOAPArrayStruct, (void*)Axis_Delete_SOAPArrayStruct, "echoNestedArrayReturn", Axis_URI_SOAPArrayStruct);
}
