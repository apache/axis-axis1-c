...
int InteropTestPortTypeBWrapper::echoSimpleTypesAsStruct(IMessageData* mc)
{
	...
	int v1 = pIWSDZ->GetElementAsInt(0,0);
	AxisChar* v2 = pIWSDZ->GetElementAsString(0,0);
...
int InteropTestPortTypeBWrapper::echoNestedStruct(IMessageData* mc)
{
	...
	return pIWSSZ->AddOutputCmplxParam(ret, (void*)Axis_Serialize_SOAPStructStruct, (void*)Axis_Delete_SOAPStructStruct, "echoNestedStructReturn", "");
}
...
int InteropTestPortTypeBWrapper::echoNestedArray(IMessageData* mc)
{
	...
	return pIWSSZ->AddOutputCmplxParam(ret, (void*)Axis_Serialize_SOAPArrayStruct, (void*)Axis_Delete_SOAPArrayStruct, "echoNestedArrayReturn", "");
}
