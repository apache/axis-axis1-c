...
class base_AxisClientException: public AxisException
{
public:
	STORAGE_CLASS_INFO base_AxisClientException();
	STORAGE_CLASS_INFO base_AxisClientException(ISoapFault* pFault);
	STORAGE_CLASS_INFO base_AxisClientException(int iExceptionCode);
	STORAGE_CLASS_INFO base_AxisClientException(exception* e);
	STORAGE_CLASS_INFO base_AxisClientException(exception* e, int iExceptionCode);
	STORAGE_CLASS_INFO base_AxisClientException(string sMessage);
	STORAGE_CLASS_INFO virtual ~base_AxisClientException() throw();
