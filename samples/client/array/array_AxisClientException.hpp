...
{
public:
	STORAGE_CLASS_INFO array_AxisClientException();
	STORAGE_CLASS_INFO array_AxisClientException(ISoapFault* pFault);
	STORAGE_CLASS_INFO array_AxisClientException(int iExceptionCode);
	STORAGE_CLASS_INFO array_AxisClientException(exception* e);
	STORAGE_CLASS_INFO array_AxisClientException(exception* e, int iExceptionCode);
	STORAGE_CLASS_INFO array_AxisClientException(string sMessage);
	STORAGE_CLASS_INFO virtual ~array_AxisClientException() throw();
