...
class MathOpsDL_AxisClientException: public AxisException
{
public:
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException();
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException(ISoapFault* pFault);
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException(int iExceptionCode);
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException(exception* e);
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException(exception* e, int iExceptionCode);
	STORAGE_CLASS_INFO MathOpsDL_AxisClientException(string sMessage);
	STORAGE_CLASS_INFO virtual ~MathOpsDL_AxisClientException() throw();
