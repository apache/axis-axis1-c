...
import org.apache.geronimo.ews.ws4j2ee.context.security.WSS4J2EEEngine;
 ...
 * 
 */
public class WSS4J2EEReceiver extends BasicHandler {

	static Log log = LogFactory.getLog(WSDoAllReceiver.class.getName());
	static final WSS4J2EEEngine secEngine = new WSS4J2EEEngine();
	...
	public void invoke(MessageContext mc) throws AxisFault {
		...
		try {
			secEngine.setMessageContext(msgContext);
			wsResult =
