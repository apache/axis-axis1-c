 ...
 */ 
public class ArrayOf_xsd_short  implements org.apache.axismora.encoding.InOutParameter{
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			org.apache.axismora.wrappers.simpleType.ShortParam item =(new org.apache.axismora.wrappers.simpleType.ShortParam(msgdata));
					obj.add(item);
			org.apache.axismora.wsdl2ws.java.ParmWriter.tag = msgdata.getTag();
		}
		...
		for(int i = 0;i<length;i++)
			arr[i] = ((org.apache.axismora.wrappers.simpleType.ShortParam)obj.get(i)).getParam();
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ArrayOf_xsd_short";
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns42:short\"  xmlns:ns42 = \"http://www.w3.org/2001/XMLSchema\">");
