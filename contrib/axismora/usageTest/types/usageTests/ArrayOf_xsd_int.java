 ...
 */ 
public class ArrayOf_xsd_int  implements org.apache.axismora.encoding.InOutParameter{
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ArrayOf_xsd_int";
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns43:int\"  xmlns:ns43 = \"http://www.w3.org/2001/XMLSchema\">");
