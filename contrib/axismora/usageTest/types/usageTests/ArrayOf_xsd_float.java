 ...
 */ 
public class ArrayOf_xsd_float  implements org.apache.axismora.encoding.InOutParameter{
	public ArrayOf_xsd_float(){
	}
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ArrayOf_xsd_float";
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns44:float\"  xmlns:ns44 = \"http://www.w3.org/2001/XMLSchema\">");
