 ...
 */ 
public class ItemIdArray  implements org.apache.axismora.encoding.InOutParameter{
	public ItemIdArray(){
	}
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns20:string\"  xmlns:ns20 = \"http://www.w3.org/2001/XMLSchema\">");
			if(param[i]!=null){
