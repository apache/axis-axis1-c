 ...
 */ 
public class RemoveShoppingCartItemsRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public RemoveShoppingCartItemsRequest(java.lang.String tag,java.lang.String devtag,java.lang.String CartId,java.lang.String HMAC,java.lang.String[] Items,java.lang.String locale){
		this.tag = tag;
		this.devtag = devtag;
		this.CartId = CartId;
		this.HMAC = HMAC;
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("tag")) {
					...
					com.bookshop.soap.ItemIdArray arrayT4 = (new com.bookshop.soap.ItemIdArray());
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "RemoveShoppingCartItemsRequest";
		...
		context.writeString("<Items xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:string[]\" xmlns:ns2 = \"http://www.w3.org/2001/XMLSchema\">");
		if(this.Items!=null){
			context.writeString("\n");
			com.bookshop.soap.ItemIdArray item4 = new com.bookshop.soap.ItemIdArray();
