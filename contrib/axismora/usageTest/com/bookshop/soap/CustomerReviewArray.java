 ...
 */ 
public class CustomerReviewArray  implements org.apache.axismora.encoding.InOutParameter{
	public CustomerReviewArray(){
	}

	private com.bookshop.soap.CustomerReview[] param;
	public com.bookshop.soap.CustomerReview[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.CustomerReview[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.CustomerReview  item =(new com.bookshop.soap.CustomerReview());
		...
		int length = obj.size();
		com.bookshop.soap.CustomerReview[] arr = new com.bookshop.soap.CustomerReview[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.CustomerReview)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns13:CustomerReview\"  xmlns:ns13 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
