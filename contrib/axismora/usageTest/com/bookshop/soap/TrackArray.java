 ...
 */ 
public class TrackArray  implements org.apache.axismora.encoding.InOutParameter{
	public TrackArray(){
	}

	private com.bookshop.soap.Track[] param;
	public com.bookshop.soap.Track[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.Track[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.Track  item =(new com.bookshop.soap.Track());
		...
		int length = obj.size();
		com.bookshop.soap.Track[] arr = new com.bookshop.soap.Track[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.Track)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns16:Track\"  xmlns:ns16 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
