 ...
 */ 
public class ItemQuantityArray  implements org.apache.axismora.encoding.InOutParameter{
	public ItemQuantityArray(){
	}

	private com.bookshop.soap.ItemQuantity[] param;
	public com.bookshop.soap.ItemQuantity[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.ItemQuantity[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.ItemQuantity  item =(new com.bookshop.soap.ItemQuantity());
		...
		int length = obj.size();
		com.bookshop.soap.ItemQuantity[] arr = new com.bookshop.soap.ItemQuantity[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.ItemQuantity)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns10:ItemQuantity\"  xmlns:ns10 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
