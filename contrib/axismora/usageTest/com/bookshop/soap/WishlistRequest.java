 ...
 */ 
public class WishlistRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public WishlistRequest(java.lang.String wishlist_id,java.lang.String page,java.lang.String tag,java.lang.String type,java.lang.String devtag,java.lang.String locale){
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("wishlist_id")) {
					this.wishlist_id= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "WishlistRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<wishlist_id>");
		if(this.wishlist_id!=null){
			context.writeString(String.valueOf(wishlist_id));
		}
		context.writeString("</wishlist_id>\n");
