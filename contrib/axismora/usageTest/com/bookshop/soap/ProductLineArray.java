 ...
 */ 
public class ProductLineArray  implements org.apache.axismora.encoding.InOutParameter{
	public ProductLineArray(){
	}

	private com.bookshop.soap.ProductLine[] param;
	public com.bookshop.soap.ProductLine[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.ProductLine[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.ProductLine  item =(new com.bookshop.soap.ProductLine());
		...
		int length = obj.size();
		com.bookshop.soap.ProductLine[] arr = new com.bookshop.soap.ProductLine[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.ProductLine)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ProductLineArray";
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns30:ProductLine\"  xmlns:ns30 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
