 ...
 */ 
public class SimilarProductsArray  implements org.apache.axismora.encoding.InOutParameter{
	public SimilarProductsArray(){
	}
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns26:string\"  xmlns:ns26 = \"http://www.w3.org/2001/XMLSchema\">");
			if(param[i]!=null){
