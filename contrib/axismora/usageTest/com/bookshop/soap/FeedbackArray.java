 ...
 */ 
public class FeedbackArray  implements org.apache.axismora.encoding.InOutParameter{
	public FeedbackArray(){
	}

	private com.bookshop.soap.Feedback[] param;
	public com.bookshop.soap.Feedback[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.Feedback[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.Feedback  item =(new com.bookshop.soap.Feedback());
		...
		int length = obj.size();
		com.bookshop.soap.Feedback[] arr = new com.bookshop.soap.Feedback[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.Feedback)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns24:Feedback\"  xmlns:ns24 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
