 ...
 */ 
public class DirectorRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public DirectorRequest(java.lang.String director,java.lang.String page,java.lang.String mode,java.lang.String tag,java.lang.String type,java.lang.String devtag,java.lang.String sort,java.lang.String variations,java.lang.String locale){
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("director")) {
					this.director= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "DirectorRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<director>");
		if(this.director!=null){
			context.writeString(String.valueOf(director));
		}
		context.writeString("</director>\n");
