 ...
 */ 
public class SellerSearchDetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	public SellerSearchDetailsArray(){
	}

	private com.bookshop.soap.SellerSearchDetails[] param;
	public com.bookshop.soap.SellerSearchDetails[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.SellerSearchDetails[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.SellerSearchDetails  item =(new com.bookshop.soap.SellerSearchDetails());
		...
		int length = obj.size();
		com.bookshop.soap.SellerSearchDetails[] arr = new com.bookshop.soap.SellerSearchDetails[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.SellerSearchDetails)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns32:SellerSearchDetails\"  xmlns:ns32 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
