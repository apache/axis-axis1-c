 ...
 */ 
public class KeyPhraseArray  implements org.apache.axismora.encoding.InOutParameter{
	public KeyPhraseArray(){
	}

	private com.bookshop.soap.KeyPhrase[] param;
	public com.bookshop.soap.KeyPhrase[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.KeyPhrase[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.KeyPhrase  item =(new com.bookshop.soap.KeyPhrase());
		...
		int length = obj.size();
		com.bookshop.soap.KeyPhrase[] arr = new com.bookshop.soap.KeyPhrase[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.KeyPhrase)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns33:KeyPhrase\"  xmlns:ns33 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
