 ...
 */ 
public class AsinRequest  implements org.apache.axismora.encoding.InOutParameter{
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("asin")) {
					...
					this.offer= (new org.apache.axismora.wrappers.simpleType.StringParam(msgdata)).getParam();
				}else if (localName.equalsIgnoreCase("offerpage")) {
					this.offerpage= (new org.apache.axismora.wrappers.simpleType.StringParam(msgdata)).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		context.writeString("<offer>");
		if(this.offer!=null){
			context.writeString(String.valueOf(offer));
		}
		context.writeString("</offer>\n");

		context.writeString("<offerpage>");
		if(this.offerpage!=null){
			context.writeString(String.valueOf(offerpage));
		}
		context.writeString("</offerpage>\n");
