 ...
 */ 
public class SellerSearch  implements org.apache.axismora.encoding.InOutParameter{
	private com.bookshop.soap.SellerSearchDetails[] SellerSearchDetails;

	public SellerSearch(){
	}
	public SellerSearch(com.bookshop.soap.SellerSearchDetails[] SellerSearchDetails){
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("SellerSearchDetails")) {
					com.bookshop.soap.SellerSearchDetailsArray arrayT0 = (new com.bookshop.soap.SellerSearchDetailsArray());
					arrayT0.desierialize(msgdata);
					this.SellerSearchDetails = arrayT0.getParam();
				}else
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		context.writeString("<SellerSearchDetails xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:SellerSearchDetails[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.SellerSearchDetails!=null){
			context.writeString("\n");
			com.bookshop.soap.SellerSearchDetailsArray item0 = new com.bookshop.soap.SellerSearchDetailsArray();
			item0.setParam(SellerSearchDetails);
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = true;
			item0.serialize(context);
		}
		context.writeString("</SellerSearchDetails>\n");
	...
	public void setSellerSearchDetails(com.bookshop.soap.SellerSearchDetails[] SellerSearchDetails){
		this.SellerSearchDetails = SellerSearchDetails;
	}
	public com.bookshop.soap.SellerSearchDetails[] getSellerSearchDetails(){
