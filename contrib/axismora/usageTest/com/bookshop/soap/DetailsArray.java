...
public class DetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	...
	private com.bookshop.soap.Details[] param;
	public com.bookshop.soap.Details[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.Details[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.Details  item =(new com.bookshop.soap.Details());
		...
		int length = obj.size();
		com.bookshop.soap.Details[] arr = new com.bookshop.soap.Details[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.Details)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns11:Details\"  xmlns:ns11 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
