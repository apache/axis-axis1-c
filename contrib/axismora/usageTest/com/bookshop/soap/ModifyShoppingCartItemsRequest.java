 ...
 */ 
public class ModifyShoppingCartItemsRequest  implements org.apache.axismora.encoding.InOutParameter{
	private java.lang.String tag;
	private java.lang.String devtag;
	private java.lang.String CartId;
	private java.lang.String HMAC;
	private com.bookshop.soap.ItemQuantity[] Items;
	private java.lang.String locale;

	public ModifyShoppingCartItemsRequest(){
	}
	public ModifyShoppingCartItemsRequest(java.lang.String tag,java.lang.String devtag,java.lang.String CartId,java.lang.String HMAC,com.bookshop.soap.ItemQuantity[] Items,java.lang.String locale){
		this.tag = tag;
		this.devtag = devtag;
		this.CartId = CartId;
		this.HMAC = HMAC;
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("tag")) {
					...
					com.bookshop.soap.ItemQuantityArray arrayT4 = (new com.bookshop.soap.ItemQuantityArray());
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ModifyShoppingCartItemsRequest";
		...
		context.writeString("<Items xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:ItemQuantity[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.Items!=null){
			context.writeString("\n");
			com.bookshop.soap.ItemQuantityArray item4 = new com.bookshop.soap.ItemQuantityArray();
	...
	public void setItems(com.bookshop.soap.ItemQuantity[] Items){
		this.Items = Items;
	}
	public com.bookshop.soap.ItemQuantity[] getItems(){
		return Items;
	}
