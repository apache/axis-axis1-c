 ...
 */ 
public class MarketplaceSearchDetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	public MarketplaceSearchDetailsArray(){
	}

	private com.bookshop.soap.MarketplaceSearchDetails[] param;
	public com.bookshop.soap.MarketplaceSearchDetails[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.MarketplaceSearchDetails[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.MarketplaceSearchDetails  item =(new com.bookshop.soap.MarketplaceSearchDetails());
		...
		int length = obj.size();
		com.bookshop.soap.MarketplaceSearchDetails[] arr = new com.bookshop.soap.MarketplaceSearchDetails[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.MarketplaceSearchDetails)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns28:MarketplaceSearchDetails\"  xmlns:ns28 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
