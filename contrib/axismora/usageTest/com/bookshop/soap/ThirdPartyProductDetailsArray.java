 ...
 */ 
public class ThirdPartyProductDetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	public ThirdPartyProductDetailsArray(){
	}

	private com.bookshop.soap.ThirdPartyProductDetails[] param;
	public com.bookshop.soap.ThirdPartyProductDetails[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.ThirdPartyProductDetails[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.ThirdPartyProductDetails  item =(new com.bookshop.soap.ThirdPartyProductDetails());
		...
		int length = obj.size();
		com.bookshop.soap.ThirdPartyProductDetails[] arr = new com.bookshop.soap.ThirdPartyProductDetails[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.ThirdPartyProductDetails)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns21:ThirdPartyProductDetails\"  xmlns:ns21 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
