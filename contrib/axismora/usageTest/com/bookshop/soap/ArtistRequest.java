 ...
 */ 
public class ArtistRequest  implements org.apache.axismora.encoding.InOutParameter{
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("artist")) {
					this.artist= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ArtistRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<artist>");
		if(this.artist!=null){
			context.writeString(String.valueOf(artist));
		}
		context.writeString("</artist>\n");
