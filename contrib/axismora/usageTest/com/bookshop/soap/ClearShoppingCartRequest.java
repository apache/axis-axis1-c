 ...
 */ 
public class ClearShoppingCartRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public ClearShoppingCartRequest(java.lang.String tag,java.lang.String devtag,java.lang.String CartId,java.lang.String HMAC,java.lang.String locale){
		this.tag = tag;
		this.devtag = devtag;
		this.CartId = CartId;
		this.HMAC = HMAC;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ClearShoppingCartRequest";
