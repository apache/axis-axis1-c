...
public class Details  implements org.apache.axismora.encoding.InOutParameter{
	...
	private com.bookshop.soap.KeyPhrase[] KeyPhrases;
	...
	private com.bookshop.soap.ThirdPartyProductInfo ThirdPartyProductInfo;
	private java.lang.String SalesRank;
	private com.bookshop.soap.BrowseNode[] BrowseList;
	...
	private com.bookshop.soap.Track[] Tracks;
	private java.lang.String[] Accessories;
	private java.lang.String[] Platforms;
	private java.lang.String Encoding;
	private com.bookshop.soap.Reviews Reviews;
	...
	public Details(java.lang.String Url,java.lang.String Asin,java.lang.String ProductName,java.lang.String Catalog,com.bookshop.soap.KeyPhrase[] KeyPhrases,java.lang.String[] Artists,java.lang.String[] Authors,java.lang.String Mpn,java.lang.String[] Starring,java.lang.String[] Directors,java.lang.String TheatricalReleaseDate,java.lang.String ReleaseDate,java.lang.String Manufacturer,java.lang.String Distributor,java.lang.String ImageUrlSmall,java.lang.String ImageUrlMedium,java.lang.String ImageUrlLarge,java.lang.String ListPrice,java.lang.String OurPrice,java.lang.String UsedPrice,java.lang.String RefurbishedPrice,java.lang.String CollectiblePrice,java.lang.String ThirdPartyNewPrice,java.lang.String NumberOfOfferings,java.lang.String ThirdPartyNewCount,java.lang.String UsedCount,java.lang.String CollectibleCount,java.lang.String RefurbishedCount,com.bookshop.soap.ThirdPartyProductInfo ThirdPartyProductInfo,java.lang.String SalesRank,com.bookshop.soap.BrowseNode[] BrowseList,java.lang.String Media,java.lang.String ReadingLevel,java.lang.String Publisher,java.lang.String NumMedia,java.lang.String Isbn,java.lang.String[] Features,java.lang.String MpaaRating,java.lang.String EsrbRating,java.lang.String AgeGroup,java.lang.String Availability,java.lang.String Upc,com.bookshop.soap.Track[] Tracks,java.lang.String[] Accessories,java.lang.String[] Platforms,java.lang.String Encoding,com.bookshop.soap.Reviews Reviews,java.lang.String[] SimilarProducts,java.lang.String[] Lists,java.lang.String Status){
		this.Url = Url;
		this.Asin = Asin;
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("Url")) {
					...
					com.bookshop.soap.KeyPhraseArray arrayT4 = (new com.bookshop.soap.KeyPhraseArray());
					arrayT4.desierialize(msgdata);
					this.KeyPhrases = arrayT4.getParam();
				}else if (localName.equalsIgnoreCase("Artists")) {
					com.bookshop.soap.ArtistArray arrayT5 = (new com.bookshop.soap.ArtistArray());
					arrayT5.desierialize(msgdata);
					this.Artists = arrayT5.getParam();
				}else if (localName.equalsIgnoreCase("Authors")) {
					com.bookshop.soap.AuthorArray arrayT6 = (new com.bookshop.soap.AuthorArray());
					...
					com.bookshop.soap.StarringArray arrayT8 = (new com.bookshop.soap.StarringArray());
					arrayT8.desierialize(msgdata);
					this.Starring = arrayT8.getParam();
				}else if (localName.equalsIgnoreCase("Directors")) {
					com.bookshop.soap.DirectorArray arrayT9 = (new com.bookshop.soap.DirectorArray());
					...
					this.ThirdPartyProductInfo= (new com.bookshop.soap.ThirdPartyProductInfo());
					...
					com.bookshop.soap.BrowseNodeArray arrayT30 = (new com.bookshop.soap.BrowseNodeArray());
					...
					com.bookshop.soap.FeaturesArray arrayT36 = (new com.bookshop.soap.FeaturesArray());
					...
					com.bookshop.soap.TrackArray arrayT42 = (new com.bookshop.soap.TrackArray());
					arrayT42.desierialize(msgdata);
					this.Tracks = arrayT42.getParam();
				}else if (localName.equalsIgnoreCase("Accessories")) {
					com.bookshop.soap.AccessoryArray arrayT43 = (new com.bookshop.soap.AccessoryArray());
					arrayT43.desierialize(msgdata);
					this.Accessories = arrayT43.getParam();
				}else if (localName.equalsIgnoreCase("Platforms")) {
					com.bookshop.soap.PlatformArray arrayT44 = (new com.bookshop.soap.PlatformArray());
					...
					this.Reviews= (new com.bookshop.soap.Reviews());
					this.Reviews.desierialize(msgdata);
				}else if (localName.equalsIgnoreCase("SimilarProducts")) {
					com.bookshop.soap.SimilarProductsArray arrayT47 = (new com.bookshop.soap.SimilarProductsArray());
					arrayT47.desierialize(msgdata);
					this.SimilarProducts = arrayT47.getParam();
				}else if (localName.equalsIgnoreCase("Lists")) {
					com.bookshop.soap.ListArray arrayT48 = (new com.bookshop.soap.ListArray());
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		context.writeString("<KeyPhrases xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:KeyPhrase[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.KeyPhrases!=null){
			context.writeString("\n");
			com.bookshop.soap.KeyPhraseArray item4 = new com.bookshop.soap.KeyPhraseArray();
		...
		if(this.Artists!=null){
			context.writeString("\n");
			com.bookshop.soap.ArtistArray item5 = new com.bookshop.soap.ArtistArray();
		...
		if(this.Authors!=null){
			context.writeString("\n");
			com.bookshop.soap.AuthorArray item6 = new com.bookshop.soap.AuthorArray();
		...
		if(this.Starring!=null){
			context.writeString("\n");
			com.bookshop.soap.StarringArray item8 = new com.bookshop.soap.StarringArray();
		...
		if(this.Directors!=null){
			context.writeString("\n");
			com.bookshop.soap.DirectorArray item9 = new com.bookshop.soap.DirectorArray();
		...
		context.writeString("<BrowseList xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:BrowseNode[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.BrowseList!=null){
			context.writeString("\n");
			com.bookshop.soap.BrowseNodeArray item30 = new com.bookshop.soap.BrowseNodeArray();
		...
		if(this.Features!=null){
			context.writeString("\n");
			com.bookshop.soap.FeaturesArray item36 = new com.bookshop.soap.FeaturesArray();
		...
		context.writeString("<Tracks xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:Track[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.Tracks!=null){
			context.writeString("\n");
			com.bookshop.soap.TrackArray item42 = new com.bookshop.soap.TrackArray();
		...
		if(this.Accessories!=null){
			context.writeString("\n");
			com.bookshop.soap.AccessoryArray item43 = new com.bookshop.soap.AccessoryArray();
		...
		if(this.Platforms!=null){
			context.writeString("\n");
			com.bookshop.soap.PlatformArray item44 = new com.bookshop.soap.PlatformArray();
		...
		if(this.SimilarProducts!=null){
			context.writeString("\n");
			com.bookshop.soap.SimilarProductsArray item47 = new com.bookshop.soap.SimilarProductsArray();
		...
		if(this.Lists!=null){
			context.writeString("\n");
			com.bookshop.soap.ListArray item48 = new com.bookshop.soap.ListArray();
	...
	public void setKeyPhrases(com.bookshop.soap.KeyPhrase[] KeyPhrases){
		this.KeyPhrases = KeyPhrases;
	}
	public com.bookshop.soap.KeyPhrase[] getKeyPhrases(){
		return KeyPhrases;
	}
	...
	public void setThirdPartyProductInfo(com.bookshop.soap.ThirdPartyProductInfo ThirdPartyProductInfo){
		this.ThirdPartyProductInfo = ThirdPartyProductInfo;
	}
	public com.bookshop.soap.ThirdPartyProductInfo getThirdPartyProductInfo(){
	...
	public void setBrowseList(com.bookshop.soap.BrowseNode[] BrowseList){
		this.BrowseList = BrowseList;
	}
	public com.bookshop.soap.BrowseNode[] getBrowseList(){
		return BrowseList;
	}
	...
	public void setTracks(com.bookshop.soap.Track[] Tracks){
		this.Tracks = Tracks;
	}
	public com.bookshop.soap.Track[] getTracks(){
		return Tracks;
	}
	...
	public void setReviews(com.bookshop.soap.Reviews Reviews){
		this.Reviews = Reviews;
	}
	public com.bookshop.soap.Reviews getReviews(){
		return Reviews;
	}
