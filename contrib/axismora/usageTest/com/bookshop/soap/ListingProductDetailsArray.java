 ...
 */ 
public class ListingProductDetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	public ListingProductDetailsArray(){
	}

	private com.bookshop.soap.ListingProductDetails[] param;
	public com.bookshop.soap.ListingProductDetails[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.ListingProductDetails[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.ListingProductDetails  item =(new com.bookshop.soap.ListingProductDetails());
		...
		int length = obj.size();
		com.bookshop.soap.ListingProductDetails[] arr = new com.bookshop.soap.ListingProductDetails[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.ListingProductDetails)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns19:ListingProductDetails\"  xmlns:ns19 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
