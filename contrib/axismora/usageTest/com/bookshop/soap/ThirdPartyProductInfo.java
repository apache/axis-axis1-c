...
public class ThirdPartyProductInfo  implements org.apache.axismora.encoding.InOutParameter{
	private com.bookshop.soap.ThirdPartyProductDetails[] ThirdPartyProductDetails;

	public ThirdPartyProductInfo(){
	}
	public ThirdPartyProductInfo(com.bookshop.soap.ThirdPartyProductDetails[] ThirdPartyProductDetails){
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("ThirdPartyProductDetails")) {
					com.bookshop.soap.ThirdPartyProductDetailsArray arrayT0 = (new com.bookshop.soap.ThirdPartyProductDetailsArray());
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		context.writeString("<ThirdPartyProductDetails xsi:type=\"soapenc:Array\" soapenc:arrayType=\"ns2:ThirdPartyProductDetails[]\" xmlns:ns2 = \"http://soap.bookshop.com\">");
		if(this.ThirdPartyProductDetails!=null){
			context.writeString("\n");
			com.bookshop.soap.ThirdPartyProductDetailsArray item0 = new com.bookshop.soap.ThirdPartyProductDetailsArray();
	...
	public void setThirdPartyProductDetails(com.bookshop.soap.ThirdPartyProductDetails[] ThirdPartyProductDetails){
		this.ThirdPartyProductDetails = ThirdPartyProductDetails;
	}
	public com.bookshop.soap.ThirdPartyProductDetails[] getThirdPartyProductDetails(){
