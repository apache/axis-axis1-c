 ...
 */ 
public class ActorRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public ActorRequest(java.lang.String actor,java.lang.String page,java.lang.String mode,java.lang.String tag,java.lang.String type,java.lang.String devtag,java.lang.String sort,java.lang.String variations,java.lang.String locale){
		this.actor = actor;
		this.page = page;
		this.mode = mode;
		this.tag = tag;
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("actor")) {
					this.actor= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ActorRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<actor>");
		if(this.actor!=null){
			context.writeString(String.valueOf(actor));
		}
		context.writeString("</actor>\n");
