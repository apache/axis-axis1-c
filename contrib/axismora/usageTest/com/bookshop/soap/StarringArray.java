 ...
 */ 
public class StarringArray  implements org.apache.axismora.encoding.InOutParameter{
	public StarringArray(){
	}
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns23:string\"  xmlns:ns23 = \"http://www.w3.org/2001/XMLSchema\">");
			if(param[i]!=null){
