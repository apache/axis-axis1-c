 ...
 */ 
public class AuthorRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public AuthorRequest(java.lang.String author,java.lang.String page,java.lang.String mode,java.lang.String tag,java.lang.String type,java.lang.String devtag,java.lang.String sort,java.lang.String variations,java.lang.String locale){
		this.author = author;
		this.page = page;
		this.mode = mode;
		this.tag = tag;
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("author")) {
					this.author= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "AuthorRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<author>");
		if(this.author!=null){
			context.writeString(String.valueOf(author));
		}
		context.writeString("</author>\n");
