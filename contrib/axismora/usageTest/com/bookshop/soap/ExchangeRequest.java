 ...
 */ 
public class ExchangeRequest  implements org.apache.axismora.encoding.InOutParameter{
	...
	public ExchangeRequest(java.lang.String exchange_id,java.lang.String tag,java.lang.String type,java.lang.String devtag,java.lang.String locale){
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("exchange_id")) {
					this.exchange_id= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "ExchangeRequest";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<exchange_id>");
		if(this.exchange_id!=null){
			context.writeString(String.valueOf(exchange_id));
		}
		context.writeString("</exchange_id>\n");
