 ...
 */ 
public class AddItemArray  implements org.apache.axismora.encoding.InOutParameter{
	public AddItemArray(){
	}

	private com.bookshop.soap.AddItem[] param;
	public com.bookshop.soap.AddItem[] getParam(){
		return this.param;
	}
	public void setParam(com.bookshop.soap.AddItem[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			com.bookshop.soap.AddItem  item =(new com.bookshop.soap.AddItem());
		...
		int length = obj.size();
		com.bookshop.soap.AddItem[] arr = new com.bookshop.soap.AddItem[length];
		for(int i = 0;i<length;i++)
			arr[i] = (com.bookshop.soap.AddItem)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns18:AddItem\"  xmlns:ns18 = \"http://soap.bookshop.com\">");
			if(param[i]!=null){
