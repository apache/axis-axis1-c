 ...
 */ 
public class FeaturesArray  implements org.apache.axismora.encoding.InOutParameter{
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns14:string\"  xmlns:ns14 = \"http://www.w3.org/2001/XMLSchema\">");
			if(param[i]!=null){
