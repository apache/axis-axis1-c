 ...
 */ 
public class DetailsArray  implements org.apache.axismora.encoding.InOutParameter{
	public DetailsArray(){
	}

	private heavytest.performence.Details[] param;
	public heavytest.performence.Details[] getParam(){
		return this.param;
	}
	public void setParam(heavytest.performence.Details[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			heavytest.performence.Details  item =(new heavytest.performence.Details());
		...
		int length = obj.size();
		heavytest.performence.Details[] arr = new heavytest.performence.Details[length];
		for(int i = 0;i<length;i++)
			arr[i] = (heavytest.performence.Details)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns1:Details\"  xmlns:ns1 = \"http://performence.heavytest\">");
			if(param[i]!=null){
