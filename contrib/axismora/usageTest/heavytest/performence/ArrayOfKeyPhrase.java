 ...
 */ 
public class ArrayOfKeyPhrase  implements org.apache.axismora.encoding.InOutParameter{
	public ArrayOfKeyPhrase(){
	}

	private heavytest.performence.KeyPhrase[] param;
	public heavytest.performence.KeyPhrase[] getParam(){
		return this.param;
	}
	public void setParam(heavytest.performence.KeyPhrase[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			heavytest.performence.KeyPhrase  item =(new heavytest.performence.KeyPhrase());
		...
		int length = obj.size();
		heavytest.performence.KeyPhrase[] arr = new heavytest.performence.KeyPhrase[length];
		for(int i = 0;i<length;i++)
			arr[i] = (heavytest.performence.KeyPhrase)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns6:KeyPhrase\"  xmlns:ns6 = \"http://performence.heavytest\">");
			if(param[i]!=null){
