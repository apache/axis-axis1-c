 ...
 */ 
public class ArrayOfCustomerReview  implements org.apache.axismora.encoding.InOutParameter{
	public ArrayOfCustomerReview(){
	}

	private heavytest.performence.CustomerReview[] param;
	public heavytest.performence.CustomerReview[] getParam(){
		return this.param;
	}
	public void setParam(heavytest.performence.CustomerReview[] param){
		this.param = param;
	}
	...
	public org.apache.axismora.encoding.InParameter desierialize(org.apache.axismora.MessageContext msgdata)throws org.apache.axis.AxisFault{
		...
		while(!((org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.END_TAG) && 
			...
			heavytest.performence.CustomerReview  item =(new heavytest.performence.CustomerReview());
		...
		int length = obj.size();
		heavytest.performence.CustomerReview[] arr = new heavytest.performence.CustomerReview[length];
		for(int i = 0;i<length;i++)
			arr[i] = (heavytest.performence.CustomerReview)obj.get(i);
		 this.param = arr;
		return this;
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns5:CustomerReview\"  xmlns:ns5 = \"http://performence.heavytest\">");
			if(param[i]!=null){
