...
/* parameter class */ 
public class ArrayOfString2D  implements org.apache.axismora.encoding.InOutParameter{
public ArrayOfString2D(){
}
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		try{
				...
				String type_name = "ArrayOfString2D";
		...
		for (int i = 0; i < param.length; i++) {
			context.writeString("<item"+i+ "  xsi:type=\"ns1:string\"  xmlns:ns1 = \"http://www.w3.org/2001/XMLSchema\">");
			if(param[i]!=null){
