 ...
 */ 
public class StateType  implements org.apache.axismora.encoding.InOutParameter{
	private java.lang.String state;

	public StateType(){
	}
	public StateType(java.lang.String state){
		this.state = state;
	}
		...
		for(int i = 0;i<count;i++) {
			while(!(org.apache.axismora.wsdl2ws.java.ParmWriter.tag.getType() == org.xmlpull.v1.XmlPullParser.START_TAG))
				...
				if(localName.equalsIgnoreCase("state")) {
					this.state= new org.apache.axismora.wrappers.simpleType.StringParam(msgdata).getParam();
				}else
	...
	public void serialize(org.apache.axis.encoding.SerializationContext context)throws java.io.IOException{
		...
		String type_name = "stateType";
			org.apache.axismora.wsdl2ws.java.ParmWriter.tagWritten = false;
		//write the parameters

		context.writeString("<state>");
		if(this.state!=null){
			context.writeString(String.valueOf(state));
		}
		context.writeString("</state>\n");
