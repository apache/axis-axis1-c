...
public class MarketplaceSearchDetails  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.bookshop.com", "MarketplaceSearchDetails"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://soap.bookshop.com", "ListingProductInfo"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
