...
public class Reviews  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://soap.bookshop.com", "Reviews"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://soap.bookshop.com", "CustomerReview"));
        elemField.setMinOccurs(0);
        typeDesc.addFieldDesc(elemField);
    }
